...
/**
 * CraftPushNotificationsAsset AssetBundle
 *
 ...
 * @since     0.1.0
 */
class CraftPushNotificationsAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@levinriegner/craftpushnotifications/assetbundles/craftpushnotifications/dist";
        ...
        $this->js = [
            'js/CraftPushNotifications.js',
        ];

        $this->css = [
            'css/CraftPushNotifications.css',
        ];
